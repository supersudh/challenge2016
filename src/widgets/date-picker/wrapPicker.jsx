...
export default function wrapPicker(Picker, defaultFormat) {
  return class PickerWrapper extends React.Component {
    ...
    getLocale() {
      ...
      if (context.shieldLocale && context.shieldLocale.DatePicker) {
        locale = context.shieldLocale.DatePicker;
      }
      // 统一合并为完整的 Locale
    ...
    render() {
      ...
      const pickerClass = classNames({
        'shield-calendar-picker': true,
        'shield-calendar-picker-open': state.open,
      });
      const pickerInputClass = classNames({
        'shield-calendar-range-picker': true,
        'shield-input': true,
        'shield-input-lg': props.size === 'large',
        'shield-input-sm': props.size === 'small',
      });
