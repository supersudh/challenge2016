  ...
  render() {
    ...
    return (<span className={props.pickerClass} style={style}>
      <RcDatePicker
        ...
        calendar={calendar}
        value={state.value}
        prefixCls="shield-calendar-picker-container"
        style={popupStyle}
        align={align}
            ...
            return (
              <span className={props.pickerInputClass} disabled={disabled}>
                <input
                  ...
                  className="shield-calendar-range-picker-input" />
                <span className="shield-calendar-range-picker-separator"> ~ </span>
                <input
                  disabled={disabled}
                  onChange={props.handleInputChange}
                  ...
                  className="shield-calendar-range-picker-input" />
                <span className="shield-calendar-picker-icon" />
              </span>
            );
          }
        }
