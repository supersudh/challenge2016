...
export default class TimePicker extends React.Component {
  ...
  getSizeClass() {
    ...
    if (this.props.size === 'large') {
      sizeClass = ' shield-input-lg';
    } else if (this.props.size === 'small') {
      sizeClass = ' shield-input-sm';
    }
    return sizeClass;
  }
  ...
  getLocale() {
    ...
    if (this.context.shieldLocale && this.context.shieldLocale.TimePicker) {
      locale = this.context.shieldLocale.TimePicker;
    }
    // 统一合并为完整的 Locale
